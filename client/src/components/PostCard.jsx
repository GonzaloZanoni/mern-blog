...
export default function PostCard({ post }) {
    return (
        <div className="group relative w-full dark:border dark:border-green-500 hover:shadow-custom-green dark:shadow-none h-[350px] overflow-hidden rounded-lg sm:w-[400px] transition-all shadow-2xl">

            <img src={post.image} alt="" className="h-[180px] w-full object-cover group-hover:h-[200px] transition-all duration-300 z-20" />
            <div className="p-3 flex flex-col gap-2">
                <p className="text-lg uppercase font-semibold line-clamp-2">{post.title}</p>
